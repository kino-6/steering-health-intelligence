...
シート本体: [data/sotif_eooc_assumption_sheet.tsv](../data/sotif_eooc_assumption_sheet.tsv)(**37項目**。[docs/179](179_eooc_sheet_completion.md)でE節/F節を追加、[docs/180](180_eooc_sheet_all_filled.md)で残る4空欄を充填、[docs/195](195_capability_rule_second_mechanism_results.md)でG節「Capability決定則」7項目、[docs/196](196_eps_health_element.md)でF節/G節に4項目を追加。**うち1項目 EOOC033 は空欄でありOEMが埋める**)
