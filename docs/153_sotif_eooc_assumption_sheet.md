...
シート本体: [data/sotif_eooc_assumption_sheet.tsv](../data/sotif_eooc_assumption_sheet.tsv)(**26項目、空欄ゼロ**。[docs/179](179_eooc_sheet_completion.md)でE節/F節を追加、[docs/180](180_eooc_sheet_all_filled.md)で残る4空欄を充填)
