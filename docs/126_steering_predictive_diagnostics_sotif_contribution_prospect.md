...
- 初期の利用者はEPSサプライヤ**社内**の安全担当と製品企画である。RFQや安全コンセプト回答で、SOTIF由来の監視・通知要求が来たときに、SPD008 payloadを回答の部品として使う
...
| KQ5 | 社内安全担当が、この転記を自業務の重複ではなく回答部品として使うと言うか | Proceed | Hold(宛先リストから安全側を外す) |
