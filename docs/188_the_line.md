...
- **capability 決定則が2機構で成立した(ただしパワー段側は指標であり能力比ではない — [docs/199](199_pulse_thermal_results.md))**([docs/193](193_str_capability_rule_results.md), [docs/195](195_capability_rule_second_mechanism_results.md))。
