...
- **capability 決定則が成立したのは巻線の層間短絡のみ**。パワー段側は指標であって能力比ではなく([docs/199](199_pulse_thermal_results.md))、
  同じ巻線でもコイル間短絡には効かず振動が要る([docs/201](201_motor_second_fault_and_vibration_results.md))([docs/193](193_str_capability_rule_results.md), [docs/195](195_capability_rule_second_mechanism_results.md))。
