...
| *(警告)* plain japanese | [AGENTS.md](AGENTS.md) 3.1 の凝った言い回し | 2026-09-07 ユーザ指摘「レポートの記述が気持ち悪すぎる。どこからこんな文体学んだの？」。検査を掛けたら**既存文書 267 行**が「——」で文をつないでいた。既存分が多いため警告に留め、新規の記述を弾く。報告文は `check_report.py` が**ブロック**する(「——」・1文90文字超・ルール0の禁止語) |
